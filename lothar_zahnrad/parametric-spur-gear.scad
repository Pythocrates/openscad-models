...
hubDia = 1;		// Hub Diameter [0 = no hub]
hubLen = 0.01;		// Hub Protrusion from the face of the gear [0 = no protrusion]
...
if (sane) 
    difference() {
        gear();
        zcyl(r=2, h=3.5, align=V_UP, $fn=120);
    }
else
